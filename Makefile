...
7b-mistral: base-models/mistral-7b dataset axolotl_bin
...
13b: base-models/llama2-13b dataset axolotl_bin
	./writelog.sh 13b
...
20b: base-models/llama2-emerhyst-20b dataset axolotl_bin
	./writelog.sh 20b
	accelerate launch -m axolotl.cli.train ./axolotl-20b.yml | tee tlogs/latest/accelerate.log
	./posttrainlog.sh 20b

34b-yi: base-models/llama2-yi-34b dataset axolotl_bin
	./writelog.sh yi-34b
...
70b: base-models/llama2-70b dataset axolotl_bin
	./writelog.sh 70b
	python -m axolotl.cli.train ./axolotl-70b.yml | tee tlogs/latest/train-final.log
	./posttrainlog.sh 70b

cabb-eval-70b: base-models/llama2-70b cabb_eval_dataset axolotl_bin
